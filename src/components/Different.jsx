    ...
    return (
        <div className='different'>
            ...
            <div className="differentSwiper">
                ...
                >
                    <SwiperSlide className='differntBox'>
                        ...
                        <div className="diff-content-text">
                            <h3>간편한 무료 배송. 매장 보유 제품은 <strong>Apple Store</strong>에서 직접 픽업 가능.</h3>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='differntBox'>
                        <div className='diff-content-icon'>
                    ...
                    <SwiperSlide className='differntBox'>
                        <div className="diff-content-icon">
                        <svg width="46" height="56" viewBox="0 0 46 56" class="dd-glyph-svg2 dd-glyph-elevated" aria-hidden="true">
                    ...
                    <SwiperSlide className='differntBox'>
                        <div className="diff-content-icon">
                        <svg width="36" height="56" viewBox="0 0 36 56" class="dd-glyph-svg3 dd-glyph-elevated" aria-hidden="true">
                        ...
                        <div className="diff-content-text">
                            <h3><span>맞춤형 쇼핑</span>을 <span>Apple Store 앱</span>에서 경험하세요.</h3>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='differntBox'>
                        <div className="diff-content-icon">
                            <svg width="40" height="56" viewBox="0 0 40 56" class="dd-glyph-svg4 dd-glyph-elevated" aria-hidden="true">
                                <path d="m0 0h40v56h-40z" fill="none"></path>
                        ...
                        <div className="diff-content-text1">
                            <h3>자신만의 것이라는 증표. <br /><b>무료로 조합해서 새기는 이모티콘, 이름, 숫자.</b></h3>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='differntBox'>
                        <div className="diff-content-icon">
                            <img src={process.env.PUBLIC_URL + 'img/applelogo.png'} width="29" alt="" />
                        </div>
                        <div className="diff-content-text">
